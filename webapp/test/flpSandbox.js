		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cmpcmigracion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cmpcmigracion-display": {
								"semanticObject": "cmpcmigracion",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cmpc.migracion",
									"url": sap.ui.require.toUrl("cmpc/migracion")
								}
							}
						}
					}
